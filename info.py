...
# Bot information
SESSION = environ.get('SESSION', 'FleOniX')
...
PICS = (environ.get('PICS', 'https://envs.sh/rnN.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1242011540').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1242011540').split()]  # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001591341300').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002249745863') # give your force subscribe channel id here else leave it blank
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/FleOniX')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/FleOniX')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'FleOniX') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/FleOniX')
